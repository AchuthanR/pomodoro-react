    ...
    render() {
        return (
            <div className="Settings">
                <button type="button" className="Settings__close-btn secondary-btn" title="Close" onClick={this.props.closeModal}>
                ...
                <div className="Settings__content">
                    ...
                    <p>Made with ❤️ by Achuthan R, inspired by <a href="https://splode.github.io/pomotroid/">Pomotroid</a>.</p>
                </div>
            </div>
        );
    }
